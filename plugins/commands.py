...
async def start(client, message):
    buttons = [
        [
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/Thekumikosetsuko'),
...
async def repo_(client, message):
    ...
    await message.reply("<b>Don't ask about source code.</b>", reply_markup=InlineKeyboardMarkup(buttons))
